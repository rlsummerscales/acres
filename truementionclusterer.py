...
class TrueMentionClusterer(BaseMentionClusterer):
  ...
  def __init__(self, entityType, sentenceFilter):
    """ create a component that can be trained cluster similar mentions 
        ...
        """
    BaseMentionClusterer.__init__(self, entityType, sentenceFilter, useDetected=False)

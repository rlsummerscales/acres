...
from baseassociator import BaseAssociator
...
class RuleBasedOutcomeMeasurementLinker(BaseAssociator):
  ...
  def __init__(self):
    """ create a new mention-quantity associator given a specific mention type
        and quantity type. """
    BaseAssociator.__init__(self, 'eventrate', 'on', useLabels=True)
